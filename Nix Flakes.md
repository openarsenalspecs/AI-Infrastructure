...
- HTML Mirror: [https://roxanneardary.com/nixfiles-specification/](https://roxanneardary.com/nixfiles-specification/)
...
- nixfiles specifications are free to use with attribution. A Specification Branding License can be negotiated upon request.  
